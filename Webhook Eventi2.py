...
hook = Webhook('inserire #url webhook')
...
embed.add_field(name='**PROSSIMI EVENTI** :eyes:', value=':arrow_right:  **Attivazione CB Ch20 modo usb**\nDomenica 15/11/2020 Dalle 10:30 alle 17:00\n:arrow_right:   **Serata Modi Digitali**\n**Test Software HRD**\nSabato 21/11/2020 Ore 21:30')

embed.add_field(name='**LISTA  EVENTI PRECEDENTI** :eyes:', value=':100: **TUTORIAL GATEWAY DISCORD**\n**CLICCA SUL LINK** :arrow_down:\n https://youtu.be/pLfDxw73ZjU')
